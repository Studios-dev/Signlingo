...
export default function Rearrange({
	...
	const initialWords: () => SortableWordItem[] = () =>
		question.type != "rearrange"
			? []
			: question.words.map((text) => {
					return { id: text, text };
			  });
		...
		question.type != "rearrange" ? (
			...
			<>
				<p className="text-gray-50 mt-10 max-w-lg text-center">
					Rearrange the sentance to be the be a valid ASL sentance.
					The english translation of the end result is provided
				</p>
