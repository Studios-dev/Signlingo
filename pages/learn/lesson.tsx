...
export default function Lesson() {
  ...
  const questionComponent = ({
    rearrange: Rearrange({ question: questionJSON as RearrangeQuestion }),
    fillintheblank: FillIn({ question: questionJSON as FillInTheBlankQuestion }),
    record: FillIn({ question: questionJSON as FillInTheBlankQuestion }),
    videomultiplechoice: FillIn({
      question: questionJSON as FillInTheBlankQuestion,
    }),
    videowordbank: FillIn({ question: questionJSON as FillInTheBlankQuestion }),
    wordbank: FillIn({ question: questionJSON as FillInTheBlankQuestion }),
  } satisfies Record<
  typeof questionType,
      ...
      <div className="grow flex flex-col items-center mb-10 mt-5">
        ...
        <div className="rounded-full w-96 h-3.5 bg-white/10 relative overflow-hidden">
          <div
            ...
            style={{
              right: `${
                (1 - (question / (lesson.questions.length + 1))) * 100
              }%`,
            }}
          />
        </div>
